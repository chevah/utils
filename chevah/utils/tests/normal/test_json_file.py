...
from chevah.utils.testing import EventTestCase, manufacturer
...
class TestJSONFile(EventTestCase):
    ...
    def test_init_good_path(self):
        ...
        """
        path = manufacturer.makeFilename()
    ...
    def test_load_file_good_format(self):
        ...
        """
        string_value = manufacturer.getUniqueString()
    ...
    def test_getValueOrNone_none(self):
        ...
        json_file = manufacturer.makeJSONFile(content=content)
    ...
    def test_getValueOrNone_value(self):
        ...
        """
        value = manufacturer.getUniqueString()
